                        ...
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="alamat_petugas" id="alamat_petugas" placeholder="alamat" disabled value="{{ $petugas[0]->alamat_petugas }}">
                                </div>
